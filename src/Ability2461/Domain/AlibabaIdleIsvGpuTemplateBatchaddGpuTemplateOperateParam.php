...
class AlibabaIdleIsvGpuTemplateBatchaddGpuTemplateOperateParam {
    ...
    public function getWhitePic() : AlibabaIdleIsvGpuTemplateBatchaddGpuPicDTO{
        return $this->white_pic;
    }

    public function setWhitePic(AlibabaIdleIsvGpuTemplateBatchaddGpuPicDTO $whitePic){
    ...
    public function getMainPic() : AlibabaIdleIsvGpuTemplateBatchaddGpuPicDTO{
        return $this->main_pic;
    }

    public function setMainPic(AlibabaIdleIsvGpuTemplateBatchaddGpuPicDTO $mainPic){
