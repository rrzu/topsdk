...
class AlibabaIdleIsvItemQueryIdleItemApiCycleVendueDO {
    ...
    public function getCycleBuyActivityId() : int{
        return $this->cycle_buy_activity_id;
    }

    public function setCycleBuyActivityId(int $cycleBuyActivityId){
        $this->cycle_buy_activity_id = $cycleBuyActivityId;
    }
