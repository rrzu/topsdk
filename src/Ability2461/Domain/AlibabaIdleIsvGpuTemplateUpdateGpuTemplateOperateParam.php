...
class AlibabaIdleIsvGpuTemplateUpdateGpuTemplateOperateParam {
    ...
    public function getWhitePic() : AlibabaIdleIsvGpuTemplateUpdateGpuPicDTO{
        return $this->white_pic;
    }

    public function setWhitePic(AlibabaIdleIsvGpuTemplateUpdateGpuPicDTO $whitePic){
    ...
    public function getMainPic() : AlibabaIdleIsvGpuTemplateUpdateGpuPicDTO{
        return $this->main_pic;
    }

    public function setMainPic(AlibabaIdleIsvGpuTemplateUpdateGpuPicDTO $mainPic){
