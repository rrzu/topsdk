...
class AlibabaIdleIsvItemQueryItemLeaseDO {
    ...
    public function getRentalDepositPriceInCent() : string{
        return $this->rental_deposit_price_in_cent;
    }

    public function setRentalDepositPriceInCent(string $rentalDepositPriceInCent){
